...
int kbase_mem_flags_change(struct kbase_context *kctx, u64 gpu_addr, unsigned int flags, unsigned int mask)
{
	...
	/* There is no use case to support MEM_FLAGS_CHANGE ioctl for
	 * allocations that have NO_USER_FREE flag set, to mark them as
	 * evictable/reclaimable.
	 * This would usually include JIT allocations, Tiler heap related
	 * allocations & GPU queue ringbuffer and none of them needs to be
	 * explicitly marked as evictable by Userspace.
	 */
