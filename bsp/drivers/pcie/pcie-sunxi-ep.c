...
static void sunxi_pcie_setup_ep(struct pcie_port *pp)
{
...
sunxi_pcie_ep_get_func_from_ep(struct sunxi_pcie_ep *ep, u8 func_no)
{
...
static int sunxi_pcie_start_link(struct sunxi_pcie *pcie)
{
	sunxi_pcie_ltssm_enable(pcie, true);

	return 0;
}

static void sunxi_pcie_stop_link(struct sunxi_pcie *pcie)
{
...
sunxi_pcie_ep_get_features(struct pci_epc *epc, u8 func_no, u8 vfunc_no)
{
...
EXPORT_SYMBOL_GPL(sunxi_plat_ep_init);
