...
#define SUNXI_MODNAME		"sound-pcmhdmi"
...
snd_pcm_uframes_t snd_dmaengine_pcm_pointer_raw(struct snd_pcm_substream *substream)
{
					   ...
					   struct snd_pcm_substream *substream)
{
	...
	if (g_pcm.hdmi_fmt > HDMI_FMT_PCM)
		pos = snd_dmaengine_pcm_pointer_raw(substream);
	else
