...
#if !defined CONFIG_ARCH_SUN55IW3 && defined CONFIG_D3D_COMPRESS_EN
...
*/
#if defined CONFIG_ARCH_SUN60IW1 && !defined CONFIG_D3D_COMPRESS_EN
...
static void isp_reserve_for_yuv(unsigned int *phy_addr, unsigned int *buf_size)
{
	unsigned int i;
	void *vaddr = NULL;
...
#ifndef CONFIG_RV_RUN_CAR_REVERSE
	isp_reserve_for_yuv(phy_addr, buf_size);
