...
extern void sunxi_spi_bit_start_xfer(void __iomem *base_addr);
extern u32 sunxi_spi_bit_qry_irq_pending(void __iomem *base_addr);
extern void sunxi_spi_bit_clr_irq_pending(void __iomem *base_addr);
extern void sunxi_spi_bit_enable_irq(void __iomem *base_addr);
extern void sunxi_spi_bit_disable_irq(void __iomem *base_addr);
extern void sunxi_spi_bit_set_bc(void __iomem *base_addr, u32 tx_len, u32 rx_len);
extern void sunxi_spi_bit_ss_owner(void __iomem *base_addr, u32 owner);

extern void sunxi_spi_bit_set_cs(struct spi_device *spi, bool status);
extern int sunxi_spi_bit_sample_delay(struct spi_device *spi, u32 clk);
extern void sunxi_spi_bit_config_tc(void __iomem *base_addr, u32 config);
extern int sunxi_spi_bit_cpu_rx(struct spi_device *spi, struct spi_transfer *t);
extern int sunxi_spi_bit_cpu_tx(struct spi_device *spi, struct spi_transfer *t);
