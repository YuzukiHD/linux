...
#if defined(CONFIG_ARCH_SUN50IW12) || defined(CONFIG_ARCH_SUN8IW21) || defined(CONFIG_ARCH_SUN55IW3)
...
#undef SS_RSA_ENABLE
#undef SS_HMAC_SHA1_ENABLE
#undef SS_HMAC_SHA256_ENABLE
#endif
...
#define SS_WAIT_TIME			1000 /* 40s, used in wait_for_completion_timeout() */
