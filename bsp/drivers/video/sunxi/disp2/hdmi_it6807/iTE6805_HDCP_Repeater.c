...
#if CTS_HDCP14 /* for HDCP1.4 CTS, need disable HDCP2.2 or CTS fail (should \
				  not have value in Rsvd Register) */
...
#if _Enable_6615_CB_
	iTE6805_DATA.CB_HDCP.iTE6805_Get_DownstreamHDCPStatus_CB =
		iTE6615_Get_DownstreamHDCPStatus_CB;
	iTE6805_DATA.CB_HDCP.iTE6805_Set_DownstreamHDCPVersion_CB =
		iTE6615_Set_DownstreamHDCPVersion_CB;
#endif
}
...
void iTE6805_HDCP_Repeater_fsm(void)
{
	...
	case STATER_6805_HDCP_AuthPart2_Start:
		HDCP_DEBUG_PRINTF(
			"STATER_6805 in STATER_6805_HDCP_AuthPart2_Start \r\n");
		...
		/* init RxInfo */
		hdmirxwr(0xE4,
				 0x12); /* HDCP2_0_REPEATER_DOWNSTREAM = 1, DEVICE_COUNT = 1 */
	...
	case STATER_6805_HDCP_PrepareSendReady:
		HDCP_DEBUG_PRINTF(
			"STATER_6805 in STATER_6805_HDCP_PrepareSendReady \r\n");
...
void iTE6805_HDCP_Repeater_chg(STATER_Type New_STATE)
{
	...
	case STATER_6805_Wait_For_HDCP_Done:
		HDCP_DEBUG_PRINTF(
			"STATER_6805 chgto STATER_6805_Wait_For_HDCP_Done \r\n");
		break;
	case STATER_6805_HDCP_AuthPart2_Start:
		HDCP_DEBUG_PRINTF(
			"STATER_6805 chgto STATER_6805_HDCP_AuthPart2_Start \r\n");
		break;
	case STATER_6805_HDCP_PrepareSendReady:
		HDCP_DEBUG_PRINTF(
			"STATER_6805 chgto STATER_6805_HDCP_PrepareSendReady \r\n");
		iTE6805_DATA.CB_HDCP.iTE6805_Get_DownstreamHDCPStatus_CB(&valid,
																 &HDCPStatus);
		/* HDCPStatus = 0 = INIT status */
		/* HDCPStatus = 1 = HDCP Success */
		/* HDCPStatus = 2 = HDCP Fail */
