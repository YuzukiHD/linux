...
#define CLOCK                                                            \
	27000000L /* 22118400L//11059200L//24000000L////27000000L//12000000L \
				 //15000000L */
...
#define MICROSECONDS_TIMER(microseconds) \
	(((CLOCK / 1000000) * (microseconds)) / MachineCycle)
#define COUNTER1ms MICROSECONDS_TIMER(1000)	  /* 1000 us = 1 ms */
#define COUNTER10ms MICROSECONDS_TIMER(10000) /* 10000 us = 10 ms */
#define Tick100us                                              \
	MICROSECONDS_TIMER(100) /* Timer 0 100us(IR sampling time) \
							 */
...
void delay1ms(iTE_u16 ms);
iTE_u8 i2c_write_byte(iTE_u8 address, iTE_u8 offset, iTE_u8 byteno,
					  iTE_u8 *wrdata, iTE_u8 DEV);
iTE_u8 i2c_read_byte(iTE_u8 address, iTE_u8 offset, iTE_u8 byteno,
					 iTE_u8 *rddata, iTE_u8 DEV);
