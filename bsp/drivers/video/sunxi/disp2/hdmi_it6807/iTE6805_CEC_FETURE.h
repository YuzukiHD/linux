...
void iTE6805_CEC_MSG_Future_Report_PA(iTE_u8 PA_LOW, iTE_u8 PA_HIGH,
									  iTE_u8 prim_devtype);
void iTE6805_CEC_MSG_Future_Give_PA(void);

void iTE6805_CEC_MSG_Future_Polling(iTE_u8 TARGET_LA);
void iTE6805_CEC_MSG_Feture_Abort(iTE_u8 TARGET_LA, iTE_u8 CEC_RXCMD,
								  iTE_u8 Abort_Reason);
void iTE6805_CEC_MSG_Reply_Feture_Abort(pCEC_FRAME RX_CEC_FRAME,
										iTE_u8 Abort_Reason);
