...
#define TMDSCLKVALUE_1080P \
	160 /* for TMDS > 160 then set RS to 00, otherwise set to 3F */
...
typedef struct {
	...
	iTE_u8 STATE_HDCP;		 /* for customer control HDCP enable/disable by this
								parameter */
	...
	Video_Data_Path
		US_Video_Out_Data_Path; /* eTTL_DDR, eTTL_HalfBusDDR, eTTL_SDR_BTA1004,
								   eTTL_DDR_BTA1004 */
	...
	iTE_u8 US_CurrentPort_EnableChange; /* enable change let polling need to do
										   it */
