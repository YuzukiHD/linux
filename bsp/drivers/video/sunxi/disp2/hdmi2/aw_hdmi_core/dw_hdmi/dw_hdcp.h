...
/**
 * @desc: hdcp main config, config hdcp14 or hdcp22
 * @hdcp: hdcp params
 * @video: video params
*/
...
/**
 * @desc: hdcp main disconfig, disconfig hdcp14 or hdcp22
*/
void dw_hdcp_main_disconfig(dw_hdmi_dev_t *dev);

/**
 * @desc: hdcp main close, close hdcp14 or hdcp22
*/
