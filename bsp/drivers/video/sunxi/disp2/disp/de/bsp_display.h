...
struct sunxi_disp_edp_ops {
	...
	int (*sunxi_edp_power_disable)(unsigned int screen_id,
								   unsigned int pwr_id);
	int (*sunxi_edp_set_panel_funs)(char *drv_name,
									struct disp_lcd_panel_fun *edp_cfg);
...
s32 bsp_disp_edp_set_panel_funs(char *name, struct disp_lcd_panel_fun *lcd_cfg);
