					 ...
					 int index)
{
	...
	} else if (int_masterid_bitmap & (1 << 1)) {
		pr_err("%s Invalid Authority\n",
	...
	} else if (int_masterid_bitmap & (1 << 2)) {
		pr_err("%s Invalid Authority\n",
	...
	} else if (int_masterid_bitmap & (1 << 3)) {
		pr_err("%s Invalid Authority\n",
	...
	} else if (int_masterid_bitmap & (1 << 4)) {
		pr_err("%s Invalid Authority\n",
	...
	} else if (int_masterid_bitmap & (1 << 5)) {
		pr_err("%s Invalid Authority\n",
	...
	} else if (int_masterid_bitmap & (1 << 6)) {
		pr_err("%s Invalid Authority\n",
