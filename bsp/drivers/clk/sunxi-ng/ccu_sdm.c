...
u32 ccu_get_sdmval(unsigned long rate, struct ccu_common *common, u32 m, u32 n)
{
	...
	pr_debug("sdm_val: 0x%x wave_stop: %llu, sdm_freq: %d freq_mode: %d\n", sdm_val, wave_step, sdm_info->sdm_freq, sdm_info->freq_mode);
