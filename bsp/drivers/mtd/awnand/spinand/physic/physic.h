...
extern int aw_spi_write_then_read_atomic(struct spi_device *spi,
										const void *txbuf,
										unsigned int n_tx,
										void *rxbuf,
										unsigned int n_rx);
extern int aw_spi_sync_atomic(struct spi_device *spi,
							struct spi_message *message);

extern int aw_spi_sync_transfer_atomic(struct spi_device *spi,
							struct spi_transfer *xfers,
							unsigned int num_xfers);

extern int aw_spi_write_atomic(struct spi_device *spi,
