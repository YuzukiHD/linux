...
void awlink_asm_start(void __iomem *mod_reg_addr, unsigned long ctrlmode, unsigned long  num);
...
void awlink_asm_rx(volatile void __iomem *addr, volatile u8 *r_fi, volatile u32 *dreg, volatile u32 *id);

void awlink_asm_start_xmit(volatile void __iomem *mod_reg_addr, volatile void __iomem *addr, volatile u32 id, volatile u32 *flag, volatile u32 *mod_reg_val, volatile u8 *pdata);
