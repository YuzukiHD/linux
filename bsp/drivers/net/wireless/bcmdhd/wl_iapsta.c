...
static void
#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)) && !(defined WL_TIMER)
wl_ext_connect_timeout(unsigned long data)
#else
wl_ext_connect_timeout(void *data)
#endif
{
...
#else
wl_ext_reconnect_timeout(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
...
#else
wl_ext_key_install_timeout(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
	struct dhd_pub *dhd;
...
#else
wl_tput_monitor_timer(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
	struct dhd_pub *dhd;
...
#else
wl_ext_restart_ap_timeout(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
	struct dhd_pub *dhd;
...
#else
wl_ext_reset_ap_timeout(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
	struct dhd_pub *dhd;
...
#else
wl_ext_rxf0ovfl_reinit_timeout(void *data)
#endif
{
	struct net_device *dev = (struct net_device *)data;
	struct dhd_pub *dhd;
