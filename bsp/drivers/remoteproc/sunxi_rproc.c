...
#define SUNXI_RPROC_VERSION "2.2.7"
...
static int sunxi_rproc_suspend_late(struct device *dev)
{
	struct rproc *rproc = dev_get_drvdata(dev);
	struct sunxi_rproc *ddata = rproc->priv;
	struct sunxi_rproc_standby *rproc_standby = ddata->rproc_standby;
	...
	return sunxi_rproc_standby_suspend_late(rproc_standby);
}

static int sunxi_rproc_resume_early(struct device *dev)
{
	struct rproc *rproc = dev_get_drvdata(dev);
	struct sunxi_rproc *ddata = rproc->priv;
	struct sunxi_rproc_standby *rproc_standby = ddata->rproc_standby;
	...
	return sunxi_rproc_standby_resume_early(rproc_standby);
}
...
static struct dev_pm_ops sunxi_rproc_pm_ops = {
	...
	.suspend_late = sunxi_rproc_suspend_late,
	.resume_early = sunxi_rproc_resume_early,
